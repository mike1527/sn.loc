<?php
$_['input_firstname_text'] 		         = 'Имя';
$_['input_firstname_placeholder'] 		 = 'Пример: Аман';
$_['input_last_name_text'] 		         = 'Фамилия';
$_['input_last_name_placeholder'] 	     = 'Пример: Аманов';
$_['input_phone_text'] 		             = 'Телефон';
$_['input_phone_placeholder'] 	         = 'Пример: +993 (65) 656565';
$_['input_email_text'] 		             = 'Электронная почта';
$_['input_email_placeholder'] 	         = 'Пример: amanamanow@mail.ru';
$_['input_product_text'] 		         = 'Название предмета';
$_['input_product_placeholder'] 	     = 'Пример: Худи “H&M”';
$_['input_file_text'] 		             = 'Ссылка на предмет';
$_['input_file_data'] 		             = 'Выбрано файлов';
$_['input_product_file_placeholder'] 	     = 'Допустимые форматы(.JPG, .PNG, .PDF)';
$_['input_link_product'] 		         = 'Ссылка на предмет';
$_['input_link_product_placeholder'] 	 = 'Пример: www.ozon.ru/category/muzhchinam-31576/';
$_['comment_text'] 		                 = 'Ваш комментарий';
$_['comment_text_placeholder'] 	         = 'Пример: Прошу убедится что цвет Худи будет (черный)';
$_['button_text'] 	                     = 'Отправить заявку';
$_['checkout_bottom_text'] 	             = 'После оформления заявки, с вами свяжется наш Менаджер, который огласит вам цену и сроки поставки товара.';
